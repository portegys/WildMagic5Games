 ...
 *  SMSound.h
 *
 *	Sound library for Scorched Mars.
 *
...
// sounds created, etc ...
void SMSInitSound(char *explosionPath, char *firePath, char *windPath);
...
// to the sound. In the case of Scorched Mars, the listener is the current
